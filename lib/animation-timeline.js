...
var TimelineSelectedEvent = /*#__PURE__*/timelineSelectedEvent_createClass(function TimelineSelectedEvent() {
  ...
  timelineSelectedEvent_defineProperty(this, "drag", []);
});
...
;// CONCATENATED MODULE: ./src/enums/timelineSelectionType.ts
/**
 * Timeline selection type.
 */
var TimelineSelectionType;
(function (TimelineSelectionType) {
  TimelineSelectionType["keyframe"] = "keyframe";
  TimelineSelectionType["group"] = "group";
...
var Timeline = /*#__PURE__*/function (_TimelineEventsEmitte) {
  ...
  function Timeline() {
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_groupSelected", false);
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_zoom", function (direction, speed, x) {
      if (speed && speed > 0 && speed <= 1) {
        ...
        _this.redraw();
        _this._emitZoomEvent(null, true);
      }
    });
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "cancelHighlight", function () {
      _this._selectInternal(null);
      _this.redraw();
    });
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_handleMouseDownEvent", function (args) {
      ...
      if (target && _this._interactionMode !== TimelineInteractionMode.Zoom) {
        ...
        if (target.type === TimelineElementType.Keyframe) {
          ...
          _this._startedDragWithCtrl = _this._controlKeyPressed(args);
          _this._groupSelected = true;
          // get all related selected keyframes if we are selecting one.
          if (keyframes && !_this._controlKeyPressed(args)) {
            _this._selectInternal(keyframes);
          }
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_performClick", function (pos, drag) {
      ...
      if (drag && (drag.type === TimelineElementType.Keyframe || drag.type === TimelineElementType.Group)) {
        ...
        var keyframes = _this._groupSelected ? drag.target.keyframes : drag.target.keyframe;
        if (keyframes && _this._controlKeyPressed(pos.args)) {
          isChanged = _this._selectInternal(keyframes || null, mode).selectionChanged || isChanged;
        }
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_selectInternal", function (nodes) {
      var mode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : TimelineSelectionMode.Normal;
      var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : TimelineSelectionType.keyframe;
      if (!nodes) {
        nodes = [];
      }
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_renderRows", function () {
      ...
      try {
        ...
        viewModel.rowsViewModels.forEach(function (rowViewModel) {
          ...
          //@ts-ignore
          _this._ctx.fillStyle = rowViewModel.model.style ? rowViewModel.model.style : TimelineStyleUtils.getRowFillColor(rowViewModel.model.style || null, _this._options);
          ...
          if (bounds !== null && bounds !== void 0 && bounds.rect) {
            ...
            if (rowViewModel.model.moveStyle) {
              // eslint-disable-next-line @typescript-eslint/ban-ts-comment
              //@ts-ignore
              _this._ctx.strokeStyle = rowViewModel.model.moveStyle;
              _this._ctx.lineWidth = 1;
              _this._ctx.strokeRect(rect.x, rect.y, rect.width, rect.height);
            }
          }
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_renderGroupBounds", function (rowViewModel) {
      ...
      rowViewModel === null || rowViewModel === void 0 ? void 0 : (_rowViewModel$groupsV2 = rowViewModel.groupsViewModels) === null || _rowViewModel$groupsV2 === void 0 ? void 0 : _rowViewModel$groupsV2.forEach(function (groupsViewModels) {
        ...
        var selectedNum = 0;
        groupsViewModels.keyframesViewModels.forEach(function (e) {
          if (e.model.selected) {
            selectedNum++;
          }
        });
        var isGroupSelected = selectedNum == groupsViewModels.keyframesViewModels.length;
        ...
        if (rectBounds !== null && rectBounds !== void 0 && rectBounds.rect) {
          ...
          _this._ctx.fillRect(rect.x, rect.y, rect.width, rect.height);
          _this._ctx.strokeStyle = isGroupSelected ? '#FFEE32' : keyframeLaneColor;
          if (rect.width) {
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "onZoom", function (callback) {
      _this.on(TimelineEvents.Zoom, callback);
    });
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_emitZoomEvent", function (args, scrollProgrammatically) {
      var eventType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : TimelineEvents.Zoom;
      var zoomEvent = {
        args: args
      };
      _get((_thisSuper4 = timeline_assertThisInitialized(_this), timeline_getPrototypeOf(Timeline.prototype)), "emit", _thisSuper4).call(_thisSuper4, eventType, zoomEvent);
      return zoomEvent;
    });
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_emitGroupSelected", function (state) {
